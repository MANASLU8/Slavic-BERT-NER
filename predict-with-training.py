...
MODEL_CONFIGS = {
    ...
    #'rus_bert': 'custom-configs/ner_rus_bert_lat_trained_model.json',
...
def _predict_and_train_with_config(config, tokens, output_file):
    ...
    ner = train_evaluate_model_from_config(config)
...
if __name__ == "__main__":
    ...
    if not args.run_all:
        ...
        if args.config is not None:
            _predict_and_train_with_config(args.config, tokens, args.output_file)
        else:
